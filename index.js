...
function showText(descriptionBoxId) {
  ...
  hideText(visibleId);
  if (document.getElementById(descriptionBoxId + 'button').innerText == "Show Description") {
    document.getElementById(descriptionBoxId + 'button').innerText = "Hide Description";
    document.getElementById(descriptionBoxId + 'button').className = "btn btn-danger";
  } else {
    document.getElementById(descriptionBoxId + 'button').innerText = "Show Description";
    document.getElementById(descriptionBoxId + 'button').className = "btn btn-primary";
  }
}
